NordBeats Music (University Project)
====================================
This application is based on the Universal Android Music Player Sample app from Google.
NordBeats Music is a combination of listening the songs, displaying the list of clubs and
their music list which can be upvote or downvote by a user preference on the basis of their
listening mood and also user can upload the song of their choice to the specific club or party.
