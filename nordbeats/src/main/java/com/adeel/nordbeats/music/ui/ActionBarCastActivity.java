...
//                        break;
                    case R.id.navigation_clubs:
                        activityClass = ClubsActivity.class;
                        break;
                    case R.id.navigation_live_clubs:
                        activityClass = LiveClubsActivity.class;
                        break;
                    case R.id.navigation_clubs_map:
                        activityClass = ClubMapsActivity.class;
                        break;
                    case R.id.navigation_invite_friends:
                        inviteWhatsAppFriends();
                        break;
                }
...
//        }
        else if (LiveClubsActivity.class.isAssignableFrom(getClass())) {
            navigationView.setCheckedItem(R.id.navigation_live_clubs);
        }
        else if (ClubsActivity.class.isAssignableFrom(getClass())) {
            navigationView.setCheckedItem(R.id.navigation_clubs);
        }
        else if (ClubSongsActivity.class.isAssignableFrom(getClass())) {
            navigationView.setCheckedItem(R.id.navigation_live_clubs);
        }
        else if (ClubMapsActivity.class.isAssignableFrom(getClass())) {
            navigationView.setCheckedItem(R.id.navigation_clubs_map);
        }
    }
    ...
    private void inviteWhatsAppFriends() {
        ...
        try {
            ...
            shareToWhatsApp.putExtra(Intent.EXTRA_SUBJECT, "NordBeats");
            shareToWhatsApp.putExtra(
                    android.content.Intent.EXTRA_TEXT,
                    "\nLet me recommend you NordBeats application\n\n" +
                            "Visit the page http://nordbeats.000webhostapp.com \n\n" +
                            "Developed by: Muhammad Adeel, Syed Muhammad Razi and Danyal Akhtar"
            );
